        ...
        <div>
            <Layout>
                <Head>
                    ...
                    <meta name="description" content="Before we start diving deeper into Instagram algorithm, we need a clear understanding of IG features in 2021, how they work and what can be done with them." />
                </Head>
                <ArticleStructure
                    heading="Instagram features"
                    text="Before we start diving deeper into Instagram algorithm, we need a clear understanding of IG features, how they work and what can be done with them. This is a brief list and explanation of all important features added to Instagram until now. This will be required to understand IG algorithm and not mix up any terms."
                    img="/instagram2.jpg"
                    subheading2="Posts"
